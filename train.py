...
def train_AC(in_out_dist,
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(actor.state_dict(), r"C:\Users\armin\Documents\GitHub\P920\assets\Actor.pth")
        torch.save(actor.state_dict(), r"C:\Users\armin\Documents\GitHub\P920\assets\Critic.pth")
...
def train():
    ...
    train_AC(in_out_dist=in_out_dist,
            train_dl=train_dl,
            test_dl=test_dl,
            actor=actor, 
