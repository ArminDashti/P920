...
def main():
    ...
    parser.add_argument('--sa_num_epochs', type=int, default=5)
    ...
    parser.add_argument('--ac_num_epochs', type=int, default=30)
    parser.add_argument('--actor_max_norm', type=float, default=5.0)
    parser.add_argument('--critic_max_norm', type=int, default=5.0)
